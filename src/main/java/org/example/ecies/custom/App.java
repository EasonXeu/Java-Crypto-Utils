...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String cipherText = CustomECIESUtils.encrypt(msg.getBytes(StandardCharsets.UTF_8), (BCECPublicKey) publicKey);
        System.out.println(cipherText);
        String plainMsg =
            new String(CustomECIESUtils.decrypt(cipherText, (BCECPrivateKey) privateKey), StandardCharsets.UTF_8);
